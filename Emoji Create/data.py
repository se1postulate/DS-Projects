...
#model.load_weights("tryweightsextratwo.h5")
model.fit_generator(train_generator,epochs=4 ,steps_per_epoch=None   ,validation_data=validation_generator,shuffle=True,)



#  save the weights in h5 format
model.save_weights("tryweightsextratwo.h5")
